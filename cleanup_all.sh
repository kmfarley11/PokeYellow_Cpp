...
rm -rf CMakeCache.txt CMakeFiles/ source/CMakeFiles/ test/CMakeFiles/ && rm -rf Win32/ .vs/ PokeYellow_Cpp.sln *.vcxproj* deps/SDL2* *.sln *.pc ./bin/* Makefile source/Makefile test/Makefile deps/gtest */Debug */Release */Win32 */*vcxproj* */*.dir */cmake_install.cmake */*.sln */*.o */*.tcl cmake_install.cmake Debug Testing */Testing *.tcl */CTestTestfile* CTestTestfile*
